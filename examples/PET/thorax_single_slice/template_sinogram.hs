...
Scanner parameters:= 
  ...
  Distance between crystals in axial direction (cm)           := 0.3129
  Distance between crystals in transaxial direction (cm)      := 0.3129
  Distance between blocks in axial direction (cm)             := 0.3129
  Distance between blocks in transaxial direction (cm)        := 2.5032
